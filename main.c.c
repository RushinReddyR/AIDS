#define APP_NAME		"AIDS"
#define APP_DESC		"Sniffing packets working \n\t\tAApplying filters will need extra effort"
#define APP_COPYRIGHT	"No Copyrights"
#define APP_DISCLAIMER	"THERE IS ABSOLUTELY NO WARRANTY FOR THIS PROGRAM. lol. "
